...
test("우리 학교 결과 링크는 제출 성공 영역 안에만 있다",async()=>{const html=await readFile(new URL("index.html",root),"utf8");assert.match(html,/id="submit-success"[^>]*hidden/);const links=html.match(/우리 학교 결과 보기/g)||[];assert.equal(links.length,1);});
